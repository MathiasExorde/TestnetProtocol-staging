...
contract Statistics is Ownable {
    ...
    function isMonitoredAddress(address _address)
        public
        view
        returns (bool)
    {
    ...
    function TotalTxCount()
        public
        view
        returns(uint256)
    {
        uint256 _totalCount = 0;
        for(uint i = 0 ; i < MonitoredSystemAddress.length ; i++){
    ...
    function TotalActiveWorkerCount()
        public
        view
        returns(uint256)
    {
    ...
    function TotalAvailableWorkerCount()
        public
        view
        returns(uint256)
    {
