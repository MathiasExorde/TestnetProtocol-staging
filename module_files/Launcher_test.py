...
to = 60    
contracts = requests.get("https://raw.githubusercontent.com/MathiasExorde/TestnetProtocol-staging/main/newAddresses.txt", timeout=to).json()
abis = dict()
...
for value in ["_moduleHashContractsTest","_moduleHashTransactionTest","_moduleHashSpottingTest","_moduleHashSpotCheckingTest","_moduleHashFormattingTest","_moduleHashAppTest"]:
...
# for value in ["https://ipfs.io/ipfs/QmTDv2gQbUVktSnq1Ykx62rqGJraXSCUcFAzvSCa2be8Vw",                 #Contracts_test
#               "https://ipfs.io/ipfs/bafybeifutccfdkeikkfz52z3hcrhf7nzk5frjavcgwazyvfuz54e32o5ti/TransactionManager.py",              #Transactions_test
#               "https://ipfs.io/ipfs/QmTNWvkhRQW13pYV9gVxrtmZTrkjuwbYA3NvooL1tnKBFQ",                        #Spotting_test
#               "https://ipfs.io/ipfs/QmcLmRfJM25wkh5u8d7T2gvRwXFTQ3tV4Yo1FrAZyVVHP9",              #SpotChecking_test
#               "https://ipfs.io/ipfs/QmfZYYgn8P75SSGGV47ZVE7RHwL9MZe8Yq66PQcMVy4qoD",                      #Formatting_test
#               "https://ipfs.io/ipfs/QmPxd2MbS7v8f78atNzRLfGd63M6EdWnZ7rsmgiTPX6trz"]:                      #App_test
#     print(value)
